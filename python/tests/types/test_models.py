...
def test_flow_return_model():
    ...
    flow = (
        ...
        .set_output("out_1", "1.return")
        .set_output("out_2", "2.return")
        .set_output("out_3", "3.return")
        .set_output("out_4", "4.return.abc")
        .set_output("out_5", "5.return")
        .set_output("out_6", "something.1")
    )
