...
<Tabs>
  ...
  <Tab title="Dynamic Agents">
    <ExampleGrid>
      <ExampleCard title="Real-time Data Integration" href="/examples/agents/real-time-data" />
      <ExampleCard title="Context-Aware Responses" href="/examples/agents/context-aware" />
    </ExampleGrid>
  </Tab>
  ...
  <Tab title="Evals">
    <ExampleGrid>
      ...
      <ExampleCard title="Tool Usage Validation" href="/examples/agents/tool-usage-validation" />
