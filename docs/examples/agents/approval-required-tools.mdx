...
This example wires up a refund tool that gates above $100, captures the `ApprovalEvent` mid-stream, and resumes with a decision. See the full reference on the [Human in the Loop](/agents/human-in-the-loop) page.
