...
<Note>Source: [Anthropic model docs](https://docs.anthropic.com/en/docs/about-claude/models) · [Opus 4.7 pricing](https://docs.anthropic.com/en/about-claude/pricing)</Note>
