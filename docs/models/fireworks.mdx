...
<CardGroup cols={2}>
  ...
  Alibaba Qwen 3.8 Max on Fireworks serverless: flagship MoE for long-horizon coding and agentic work. Replacement for retired qwen3p7-plus.
