...
<Note>Source: [OpenAI model docs](https://platform.openai.com/docs/models)</Note>
...
<Warning>**gpt-5.1-mini** does not exist as a standalone API model. Use `gpt-5-mini` or `gpt-5.1-codex` instead.</Warning>
