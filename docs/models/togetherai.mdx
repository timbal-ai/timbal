...
<CardGroup cols={2}>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/Qwen/Qwen3.5-397B-A17B) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/Qwen/Qwen3-235B-A22B-Instruct-2507-tput) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/Qwen/Qwen2.5-7B-Instruct-Turbo) before use.</Warning>
...
<CardGroup cols={2}>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/deepseek-ai/DeepSeek-V4-Pro) before use.</Warning>
...
<CardGroup cols={2}>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/moonshotai/Kimi-K2.6) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/MiniMaxAI/MiniMax-M2.7) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/zai-org/GLM-5) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/zai-org/GLM-5.1) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/google/gemma-3n-E4B-it) before use.</Warning>
  ...
  <Warning>Dedicated only — create and start a [dedicated endpoint](https://api.together.ai/models/deepcogito/cogito-v2-1-671b) before use.</Warning>
