...
<div className={styles.categoriesGrid}>
  <Link className={styles.categoryBox} to="/examples/healthcare">
  ...
  <Link className={styles.categoryBox} to="/examples/automotive">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Automotive */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 640 512">
  ...
  <Link className={styles.categoryBox} to="/examples/design">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Design */}
  ...
  <Link className={styles.categoryBox} to="/examples/tourism">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Tourism */}
  ...
  <Link className={styles.categoryBox} to="/examples/financials">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Financials */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 512 512">
  ...
  <Link className={styles.categoryBox} to="/examples/ecommerce">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Ecommerce */}
  ...
  <Link className={styles.categoryBox} to="/examples/industry">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Industry */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 576 512">
  ...
  <Link className={styles.categoryBox} to="/examples/real-estate">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Real Estate */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 576 512">
  ...
  <Link className={styles.categoryBox} to="/examples/education">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Education */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 448 512">
  ...
  <Link className={styles.categoryBox} to="/examples/legal">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Legal */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 640 512">
  ...
  <Link className={styles.categoryBox} to="/examples/transport">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Transport */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 640 512">
  ...
  <Link className={styles.categoryBox} to="/examples/media">
    <div className={styles.categoryTitleRow}>
      <span className={styles.categoryIcon}>
        {/* Media & Entertainment */}
        <svg width="28" height="28" fill="#5012cb" viewBox="0 0 640 512">
